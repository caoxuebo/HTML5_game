...
TimeSystem.prototype = {
	...
	setTransducer: function(fn, duration) {
		...
		// the specified duration; after the duration ends, the permanent transduced time
		// is restored. If you do not specify it, the transducer permanently replaces the current code
